<template>
  <div class="m__results">
    <div v-if="results.data && ( results.data.users.premiumStates.length > 0 || results.data.users.premiumCities.length > 0 || results.data.users.basic.length > 0)" class="m__results-container">
