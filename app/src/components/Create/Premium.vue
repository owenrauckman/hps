<template>
  <div class="m__create">
    ...
    <div class="m__create__navigation">
      ...
      <button class="m__create__button m__create__button--ghost" @click="()=>{$router.push('about')}">Back</button>
      <button class="m__create__button" @click.prevent="updateAreasServed">
