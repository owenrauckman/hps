<template>
  <div class="m__create">
    ...
    <div class="m__create__navigation">
      ...
      <button class="m__create__button m__create__button--ghost" @click="()=>{$router.push('account')}">Back</button>
...
export default {
  ...
  computed: {
    ...
    facebook: {
      ...
      set(facebook) { this.UPDATE_SIGN_UP_INFO({ type: 'FACEBOOK', value: facebook }); },
    },
    twitter: {
      get() { return this.signUpInfo.company.twitter; },
      set(twitter) { this.UPDATE_SIGN_UP_INFO({ type: 'TWITTER', value: twitter }); },
    },
    instagram: {
      get() { return this.signUpInfo.company.instagram; },
      set(instagram) { this.UPDATE_SIGN_UP_INFO({ type: 'INSTAGRAM', value: instagram }); },
    },
    pinterest: {
      get() { return this.signUpInfo.company.pinterest; },
      set(pinterest) { this.UPDATE_SIGN_UP_INFO({ type: 'PINTEREST', value: pinterest }); },
    },
    youtube: {
      get() { return this.signUpInfo.company.youtube; },
      set(youtube) { this.UPDATE_SIGN_UP_INFO({ type: 'YOUTUBE', value: youtube }); },
    },
  },
  methods: {
